...
async function mainWorker() {
  try {
    ...
    await mongo.Pagina_autogenerada.updateOne({ _id: ObjectId(workerData.idpage) }, { $set: { estado_scrapeo_page: 'FINALIZADO' } });
    ...
    await mongo.Pagina_autogenerada.updateOne({ _id: ObjectId(workerData.idpage) }, { $set: { estado_scrapeo_page: 'PENDING' } });
